...
import { IFormsFields } from "../entity.interface";
...
export const CreateFormssDtoFields = [
  ...
  body("fields").isArray().withMessage("لیست فیلد ها صحیح وارد نشده است"),
  body("fields.*.label").isString().withMessage("نام فیلد باید رشته باشد"),
  body("fields.*.type")
    .isString()
    .notEmpty()
